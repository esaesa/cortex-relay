...
class CLIRuntimeTests(unittest.TestCase):
    ...
    def test_orchestrator_contract_contains_completion_rules(self):
        ...
        self.assertIn("Use agent_start_async for independent parallel direct specialists", contract)
        self.assertIn("agent_start when the first result is immediately required", contract)
